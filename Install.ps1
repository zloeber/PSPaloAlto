# Run this in an administrative PowerShell prompt to install the PSPaloAlto PowerShell module:
#
# 	iex (New-Object Net.WebClient).DownloadString("https://github.com/zloeber/PSPaloAlto/raw/master/Install.ps1")
